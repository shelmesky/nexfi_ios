...
//        [self.alertView addSubview:self.promptTextField];
        ...
        /** 4.创建底部按钮bgView*/
        self.buttonBgView = [[UIView alloc]initWithFrame:CGRectMake(0, self.contentView.bottom + 30, self.alertView.frame.size.width, prowidht * 45)];
...
- (void)createButtons{
    ...
    for(NSInteger i = 0; i < 2; i++){
        ...
        [itemBtn setTitleColor:i==0?[UIColor blackColor]:RGBACOLOR(81, 186, 77, 1) forState:UIControlStateNormal];
